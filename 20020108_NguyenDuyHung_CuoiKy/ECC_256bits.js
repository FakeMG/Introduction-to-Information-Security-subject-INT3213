...
async function main() {
    ...
    var message = "chaomunghaimuoinamthanhlaptruongdhcn";
    ...
    // Bob tiếp tục phần việc
    var messagePointDecrypt = addition(m2, opposite(multiplication(m1, s, a, p)), a, p)

    console.log("Giải mã với điểm M = M2 - sM1 = M(" + messagePointDecrypt.x.toString() + ", " + messagePointDecrypt.y.toString() + ")")
