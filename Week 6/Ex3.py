...
new_binSum = "110100100100011"

print("Số mới dùng để kiểm tra:",new_binSum)

x_test = binary_to_decimal(new_binSum)

print("Toạ độ dùng để kiểm tra:",x_test)

y_test = (x_test**3 + a * x_test + b) % p

if y_test in blList:
    print(f"Ta có điểm P({x_test},{y_test}) có thuộc trên đường cong Elliptic E. Đây là điểm của bản tin sau khi được mã hoá.")
else:
    print("Thử lại")
